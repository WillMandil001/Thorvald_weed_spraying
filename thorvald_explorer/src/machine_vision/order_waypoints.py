...
class order_wp():
	...
	def order_rows(self, rows, angle):
		...
		order = []
		row_count = 0
		# rotate the data set by the vector of maximal variance
...
if __name__ == '__main__':
	...
	od = order_wp()
	result = od.order_rows(rows, 0) # give angle in radians
	# angle = 0 is horizontal lines
	#od.test_plot(rows, result)
	# find out how the angel is calculated
